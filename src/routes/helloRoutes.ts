...
import { uploadSyllabus, uploadSyllabusFile, getSubjects, getNeed, getOffers, uploadPTF, getPTF, getSyllabus, getTemplatePTF, getTemplateSyllabus, generatePDF, downloadPDF } from '../controllers/UploadController'
